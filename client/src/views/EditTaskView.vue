  ...
  <div class="edittask-wrapper">
    <div class="edittask-container">
      ...
      <nav class="breadcrumb-dopamine breadcrumb-visible mb-4 fade-up" aria-label="Breadcrumb navigation">
        <RouterLink to="/" aria-label="Go to Home"><i class="bi bi-house me-1" aria-hidden="true"></i>Home</RouterLink>
      ...
      <form v-if="!loading" @submit.prevent="updateTask" class="d-flex flex-column gap-4 fade-up delay-2" novalidate>
        ...
        <div class="form-section">
          ...
          <input
            ...
            aria-required="true"
            :aria-invalid="error && !titleInput ? 'true' : 'false'"
          >
        </div>
        ...
        <div class="form-section">
          ...
          <div class="row g-2" role="radiogroup" aria-label="Select difficulty">
            <div class="col-4">
              ...
              >
                <i class="bi bi-circle d-block mb-1" style="font-size:1.2rem" aria-hidden="true"></i>
                Easy
              </div>
            </div>
            <div class="col-4">
              ...
              >
                <i class="bi bi-dash-circle d-block mb-1" style="font-size:1.2rem" aria-hidden="true"></i>
                Medium
              </div>
            </div>
            <div class="col-4">
              ...
              >
                <i class="bi bi-fire d-block mb-1" style="font-size:1.2rem" aria-hidden="true"></i>
                Hard
              </div>
            </div>
          </div>
        ...
        <!-- ENLACE -->
        <div class="form-section">
          <label for="edit-url" class="form-label-accessible">
            <i class="bi bi-link-45deg me-2" aria-hidden="true"></i>Link
          </label>
          <p class="field-hint mb-2">Optional — attach a relevant URL to this task</p>
          <input
            id="edit-url"
            v-model="urlInput"
            type="url"
        ...
        <div class="form-section">
          ...
          <div class="d-flex gap-2 mb-3">
            <label for="new-step-input" class="visually-hidden">Add a new step</label>
            <input
              id="new-step-input"
...
@media (max-width: 768px) {
  .edittask-wrapper { padding: 1.5rem 1rem 4rem; }
}
...
.diff-option:hover           { background: var(--vanilla-light); }
.diff-option:focus-visible   { outline: 3px solid var(--cinnamon-mid); outline-offset: 2px; }
.diff-option.sel-hard        { background: var(--state-error-bg); border-color: var(--state-error); color: #7A2020; }
.diff-option.sel-medium      { background: var(--state-warn-bg);  border-color: var(--state-warn);  color: #7A5A00; }
.diff-option.sel-easy        { background: var(--state-ok-bg);    border-color: var(--state-ok);    color: #3A6E3E; }
