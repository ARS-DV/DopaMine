...
const habitsDoneCount = computed(function () {
  return habitsList.value.filter(function (h) {
    return parseInt(h.done_today) == 2;
  }).length;
});
  ...
  <div class="home-container">
    ...
    <template v-else>
        ...
        <div v-else class="d-flex flex-column gap-2">
          ...
          >
            <div class="d-flex align-items-center gap-3">
              ...
              <span class="task-title-text flex-grow-1" :class="task.done ? 'text-decoration-line-through' : ''">
                {{ task.title }}
              </span>
        ...
        <div class="d-flex flex-column gap-2">
          ...
          >
            <div class="d-flex align-items-center gap-3">
              ...
              <span class="bdg" :class="parseInt(habit.done_today) == 2 ? 'bdg-done' : parseInt(habit.done_today) == 1 ? 'bdg-tried' : 'bdg-daily'">
      ...
      <section v-else class="mb-5 fade-up delay-4">
        <h2 class="section-title"><i class="bi bi-arrow-repeat me-2"></i>Habits</h2>
...
/* colores del borde segun dificultad */
...
.stats-btn { padding: 1.2rem 1.5rem; border-radius: 12px; }
.stats-btn-icon { font-size: 1.4rem; background: rgba(255, 255, 255, 0.15); padding: 0.5rem; border-radius: 8px; }
.stats-btn-title { font-size: 0.95rem; font-weight: 700; }
.stats-btn-sub   { font-size: 0.75rem; opacity: 0.8; }
